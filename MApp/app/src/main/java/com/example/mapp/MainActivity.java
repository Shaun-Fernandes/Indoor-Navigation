            ...
            public void onMapReady(@NonNull final MapboxMap mapboxMap) {
                mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
                    ...
                    public void onStyleLoaded(@NonNull Style style) {
                        ...
                        boundingBox.add(Point.fromLngLat(55.419865, 25.132240));
                        boundingBox.add(Point.fromLngLat(55.420386, 25.132198));
                        boundingBox.add(Point.fromLngLat(55.419253, 25.131361));
                        boundingBox.add(Point.fromLngLat(55.419304, 25.131819));
                        ...
                        indoorBuildingSource = new GeoJsonSource(
                                "indoor-building", loadJsonFromAsset("bits_0_rewound.geojson"));
                ...
                buttonGroundLevel.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        indoorBuildingSource.setGeoJson(loadJsonFromAsset("bits_0_rewound.geojson"));
                    }
                });
            }
        });
